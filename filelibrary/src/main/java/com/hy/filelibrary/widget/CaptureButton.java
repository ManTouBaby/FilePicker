package com.hy.filelibrary.widget;
...
public class CaptureButton extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                // 先判断是否是点击
                if (!isLongClick && !isRecording && mode != CameraOpenType.TAKE_VIDEO) {
                ...
                if (isLongClick && mode != CameraOpenType.TAKE_PHOTO) {
     ...
     * 拍摄模式
     */
    private CameraOpenType mode;

    public void setMode(CameraOpenType mode) {
        this.mode = mode;
    }

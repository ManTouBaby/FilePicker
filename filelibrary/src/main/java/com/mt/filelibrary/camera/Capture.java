...
class Capture {
    ...
    public void capturePhoto(final int orientation) {
        ...
        CameraHelper.Builder builder = CameraHelper.getBuilder();
        camera.takePicture(null, null, (data, camera) -> {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(builder.getSavePath())) {
                    parentPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + builder.getSavePath() + File.separator + "images";
                }
    ...
    public void captureRecordStart(int orientation) {
        ...
        String parentPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getAbsolutePath() + File.separator + "Camera";
        if (!TextUtils.isEmpty(builder.getSavePath())) {
            parentPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + builder.getSavePath() + File.separator + "videos";
        }
